        ...
        <div class="row">
            ...
            <div class="col-lg-5">
                <div class="product_details">
                    ...
                    <div class="original_price"><?php echo e(number_format($product->original_price)); ?> Bath</div>
                    <div class="product_price"><?php echo e(number_format($product->product_price)); ?> Bath</div>
