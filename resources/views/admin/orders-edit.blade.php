                ...
                <table class="table table-bordererd table-hover">
                    ...
                    @foreach($orders->baskets->basket_products as $basket_product)
                        <tr>
                            ...
                            <td>{{number_format($basket_product->price,2)}} Bath</td>
                            <td>{{ $basket_product->quantity }}</td>
                            <td>{{number_format($basket_product->price * $basket_product->quantity,2)}} Bath</td>
                            <td>{{ $orders->status }}</td>
                        </tr>
                    @endforeach
                    ...
                    <tr>
                        ...
                        <td colspan="2">{{$orders->order_price}} Bath</td>
                    </tr>
